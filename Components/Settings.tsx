...
const Settings=({props}:any)=> {
  ...
  return (
    <div className='px-1 md:px-5 text-gray-700 fontInter' >

    <div  className='mt-12'>
        <label className='text-gray-900 text-base md:text-lg lg:text-xl flex items-center'  htmlFor="show_time">Show elements</label>
        <div className='flex justify-between items-center flex-wrap'>
        
            <div  className='flex items-baseline mr-1'>
                <label htmlFor="show_source" className='text-base md:text-lg lg:text-xl flex items-center'  >Source</label>
                <input className="w-auto" id="show_source" checked={props.showSource} onChange={()=>props.setShowSource(!props.showSource)} />
            </div>
